...
const VideoTranscriptionUI = () => {
  ...
  <div className="bg-white rounded-lg shadow-sm">
    <div className="p-6">
      <h2 className="text-xl font-semibold mb-4">Translated Summary</h2>
      <div className="bg-gray-50 rounded-lg p-6">
        <p className="text-gray-700 leading-relaxed">{translatedSummary}</p>
      </div>
    </div>
  </div>
)}
...
<div className="mt-4 flex space-x-4">
  <button
    onClick={() => handleTranslation('hi')}
    className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
  >
    Hindi
  </button>
  <button
    onClick={() => handleTranslation('mr')}
    className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
  >
    Marathi
  </button>
